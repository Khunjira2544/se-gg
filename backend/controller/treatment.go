...
func CreateTreatment(c *gin.Context) {
	...
	// 10: ค้นหา resolution ด้วย id			//ของเราเป็น ค้นหา Patient ด้วย id
	...
	wv := entity.Treatment{
		...
		Patient: patient, // โยงความสัมพันธ์กับ Entity Video				//**โยงความสัมพันธ์กับ Entity Faculty
		Status:  status,  // โยงความสัมพันธ์กับ Entity Playlist				Teacher
		Track:   track,
		//date_of_birth: treatment.date_of_birth, // ตั้งค่าฟิลด์ watchedTime
